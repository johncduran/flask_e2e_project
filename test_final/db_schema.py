...
class Patient(Base):
    ...
    weight = Column(Integer(100), nullable=False)
    blood_pressure = Column(String(50), nullable=False)
    workout = Column(String(50), nullable=False)



### Part 2 - initial sqlalchemy-engine to connect to db:

DATABASE_URL = "mysql+pymysql://root:Final897@34.30.218.222/john"
